        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Admin</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.admin.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <h4 class="form-section"><i class="fa fa-edit"></i> Form Admin</h4>

                                                    
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="name">Nama <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="Masukkan Nama" value="{{ old('name', $admin->name) }}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="email" name="email" class="form-control" placeholder="Masukkan Email" value="{{ old('email', $admin->email) }}" autocomplete="off" required>
                                                ...
                                                <div class="form-actions text-right">
                                                    <a href="{{ route('backsite.admin.index') }}" style="width:120px;" class="btn bg-blue-grey text-white mr-1" onclick="return confirm('Are you sure want to close this page? , Any changes you make will not be saved.')">
