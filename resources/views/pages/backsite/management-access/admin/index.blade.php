                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.admin.store') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('backsite.admin.edit', $data->id) }}">Edit</a>
                                                                        <form action="{{ route('backsite.admin.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Are Syou sure want to delete this data ?');">
                                                                            @csrf
                                                                            @method('DELETE')
