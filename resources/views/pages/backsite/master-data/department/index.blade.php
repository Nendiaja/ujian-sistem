                                ...
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <a data-action="collapse">
                                            <h4 class="card-title text-white">Add Data Department</h4>
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            <form class="form form-horizontal" id="kategoriForm" action="{{ route('admin.department.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukkan Nama Department" value="" autocomplete="off" required>
                                                            @if($errors->has('nama'))
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">List Data Department</h4>
                                    <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('admin.department.edit', $data->id) }}">Edit</a>
