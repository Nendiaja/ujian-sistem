                                ...
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <a data-action="collapse">
                                            <h4 class="card-title text-white">Add Data Soal</h4>
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            <form class="form form-horizontal" id="soal_form" action="{{ route('admin.soal.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="gambar">Gambar <code style="color:green;">optional</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                ...
                                                <tbody>
                                                    @forelse($datas as $data)
                                                        <tr data-entry-id="{{ $data->id }}">
                                                            ...
                                                            <td>
                                                                @if($data->gambar)
                                                                <img src="{{ asset('/images/' . $data->gambar ) }}" alt="{{ $data->gambar }}" class="img-thumbnail" style="width: 50px; height: 50px;">
                                                                @else
                                                                    No Image
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('admin.soal.edit', $data->opsi[0]->id) }}">Edit</a>
    ...
    function confirmSubmit() {
        swal({
            ...
            if (willSubmit) {
                ...
                document.getElementById("soal_form").submit();
            }
        });
    }
</script>
