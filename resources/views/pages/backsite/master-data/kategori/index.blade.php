                                ...
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <a data-action="collapse">
                                            <h4 class="card-title text-white">Add Data Kategori</h4>
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" id="kategoriForm" action="{{ route('admin.kategori.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="nama">Nama Kategori <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukkan Nama Kategori" value="" autocomplete="off" required>
                                                            @if($errors->has('nama'))
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('admin.kategori.edit', $data->id) }}">Edit</a>
                                                                        <form id="deleteForm{{ $data->id }}" action="{{ route('admin.kategori.destroy', $data->id) }}" method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                    ...
                                                                    <a href="{{ route('admin.soalByKategori.show', $data->id) }}" class="btn btn-success btn-sm ml-1" aria-haspopup="true" aria-expanded="false">Lihat Soal</a>
