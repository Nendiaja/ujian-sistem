                                ...
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <a data-action="collapse">
                                            <h4 class="card-title text-white">Add Data Admin</h4>
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                                ...
                                                <form class="form form-horizontal" id="userForm" action="{{ route('admin.pic.store') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('admin.pic.edit', $data->id) }}">Edit</a>
                                                                        <form id="deleteForm_{{ $data->id }}" action="{{ route('admin.pic.destroy', $data->id) }}" method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
