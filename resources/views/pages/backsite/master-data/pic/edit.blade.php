                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" id="userForm" action="{{ route('admin.admin.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="name">SAP <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="number" id="SAP" name="SAP" class="form-control" placeholder="Masukkan No. SAP" value="{{ old('SAP', $user->SAP) }}" autocomplete="off" required>
                                                ...
                                                <div class="form-actions text-right">
                                                    <a href="{{ route('admin.admin.index') }}" style="width:120px;" class="btn bg-blue-grey text-white mr-1" onclick="return confirm('Are you sure want to close this page? , Any changes you make will not be saved.')">
