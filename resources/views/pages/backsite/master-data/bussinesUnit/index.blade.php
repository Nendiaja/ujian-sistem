                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Bussines Unit</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <a data-action="collapse">
                                            <h4 class="card-title text-white">Add Data Bussines Unit</h4>
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" id="kategoriForm" action="{{ route('admin.bussinesUnit.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="nama">Nama Bussines Unit <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukkan Nama Bussines Unit" value="" autocomplete="off" required>
                                                            @if($errors->has('nama'))
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('admin.bussinesUnit.edit', $data->id) }}">Edit</a>
                                                                        <form id="deleteForm{{ $data->id }}" action="{{ route('admin.bussinesUnit.destroy', $data->id) }}" method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
