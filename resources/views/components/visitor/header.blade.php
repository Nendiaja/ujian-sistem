    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href=""><img class="brand-logo" alt="modern admin logo" src="{{ asset('/assets/backsite/app-assets/images/logo/logo2.png') }}">
                        <h5 class="brand-text">Sistem Ujian Karyawan</h5>
                    </a></li>
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">Selamat Datang {{ Auth::user()->name ?? 'Anonymous' }}
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{ route('user.profile.index') }}"><i class="ft-user"></i> Edit Profile</a>
